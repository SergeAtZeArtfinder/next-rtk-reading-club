    ...
    <>
      ...
      <section>
        ...
        <Text>
          ...
          and <Code>createAsyncThunk</Code>, which reduce boilerplate and make
      ...
      <section>
        ...
        <Text>
          ...
          used to fetch the books from the database and populate the Redux store
          before rendering the page. This ensures that the data is always
          up-to-date and available when the user accesses the app.
        </Text>
        <Text>
          While on the homepage, check out the browser devTools to see the Redux
          state in action. And check the browser console{" "}
